...
//initialize it to 480p:
	{0x3103, 0x11, 0, 0}, {0x3008, 0x82, 0, 20},{0x3008, 0x42, 0, 5},
	{0x3103, 0x03, 0, 0}, {0x3503, 0x00, 0, 0}, {0x3002, 0x1c, 0, 0},
	...
	{0x3614, 0x50, 0, 0}, {0x3618, 0x00, 0, 0}, {0x3034, 0x18, 0, 0},
	{0x3035, 0x11, 0, 0}, {0x3036, 0x46, 0, 0}, {0x3500, 0x00, 0, 0},
	{0x3501, 0x01, 0, 0}, {0x3502, 0x00, 0, 0}, {0x350a, 0x00, 0, 0},
	{0x350b, 0x3f, 0, 0}, {0x3600, 0x09, 0, 0}, {0x3601, 0x43, 0, 0},
	{0x3620, 0x33, 0, 0}, {0x3621, 0xe0, 0, 0}, {0x3622, 0x01, 0, 0},
	{0x3630, 0x2d, 0, 0}, {0x3631, 0x00, 0, 0}, {0x3632, 0x32, 0, 0},
	{0x3633, 0x52, 0, 0}, {0x3634, 0x70, 0, 0}, {0x3635, 0x13, 0, 0},
	{0x3636, 0x03, 0, 0}, {0x3702, 0x6e, 0, 0}, {0x3703, 0x52, 0, 0},
	{0x3704, 0xa0, 0, 0}, {0x3705, 0x33, 0, 0}, {0x3708, 0x64, 0, 0},
	{0x3709, 0x12, 0, 0}, {0x370b, 0x61, 0, 0}, {0x370c, 0xc3, 0, 0},
	{0x370f, 0x10, 0, 0}, {0x3715, 0x08, 0, 0}, {0x3717, 0x01, 0, 0},
	{0x371b, 0x20, 0, 0}, {0x3731, 0x22, 0, 0}, {0x3739, 0x70, 0, 0},
	{0x3901, 0x0a, 0, 0}, {0x3905, 0x02, 0, 0}, {0x3906, 0x10, 0, 0},
	{0x3719, 0x86, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	...
	{0x3821, 0x07, 0, 0}, {0x3824, 0x01, 0, 0}, {0x3826, 0x03, 0, 0},
	{0x3828, 0x08, 0, 0}, {0x3a02, 0x03, 0, 0}, {0x3a03, 0xd8, 0, 0},
	{0x3a08, 0x01, 0, 0}, {0x3a09, 0x0e, 0, 0}, {0x3a0a, 0x00, 0, 0},
	{0x3a0b, 0xf6, 0, 0}, {0x3a0e, 0x03, 0, 0}, {0x3a0d, 0x04, 0, 0},
	{0x3a14, 0x03, 0, 0}, {0x3a15, 0xd8, 0, 0}, {0x3a18, 0x01, 0, 0},
	{0x3a19, 0xf8, 0, 0},
	{0x3c01, 0x34, 0, 0}, {0x3c04, 0x28, 0, 0}, {0x3c05, 0x98, 0, 0},
	{0x3c07, 0x07, 0, 0}, {0x3c09, 0xc2, 0, 0}, {0x3c0a, 0x9c, 0, 0},
	{0x3c0b, 0x40, 0, 0}, {0x3c01, 0x34, 0, 0}, {0x4001, 0x02, 0, 0},
	{0x4004, 0x02, 0, 0}, {0x4005, 0x18, 0, 0}, 
	{0x4050, 0x6e, 0, 0}, {0x4051, 0x8f, 0, 0},	{0x4300, 0x32, 0, 0},/* U Y V Y */
	{0x4514, 0x00, 0, 0}, {0x4520, 0xb0, 0, 0}, {0x460b, 0x37, 0, 0},
	{0x460c, 0x20, 0, 0}, {0x4818, 0x01, 0, 0}, {0x481d, 0xf0, 0, 0},
	{0x481f, 0x50, 0, 0}, {0x4823, 0x70, 0, 0}, {0x4831, 0x14, 0, 0},
	{0x4837, 0x16, 0, 0}, {0x5000, 0xa7, 0, 0}, {0x5001, 0x83, 0, 0},
	{0x501d, 0x00, 0, 0}, {0x501f, 0x00, 0, 0}, {0x503d, 0x00, 0, 0},
	{0x505c, 0x30, 0, 0}, {0x5181, 0x59, 0, 0}, {0x5183, 0x00, 0, 0},
	{0x5191, 0xf0, 0, 0}, {0x5192, 0x03, 0, 0}, {0x5684, 0x10, 0, 0},
	{0x5685, 0xa0, 0, 0}, {0x5686, 0x0c, 0, 0}, {0x5687, 0x78, 0, 0},
	{0x5a00, 0x08, 0, 0}, {0x5a21, 0x00, 0, 0}, {0x5a24, 0x00, 0, 0},
	{0x3008, 0x02, 0, 0}, {0x3503, 0x00, 0, 0}, {0x5180, 0xff, 0, 0},
	{0x5181, 0xf2, 0, 0}, {0x5182, 0x00, 0, 0}, {0x5183, 0x14, 0, 0},
	{0x5184, 0x25, 0, 0}, {0x5185, 0x24, 0, 0}, {0x5186, 0x09, 0, 0},
	{0x5187, 0x09, 0, 0}, {0x5188, 0x0a, 0, 0}, {0x5189, 0x75, 0, 0},
	{0x518a, 0x52, 0, 0}, {0x518b, 0xea, 0, 0}, {0x518c, 0xa8, 0, 0},
	{0x518d, 0x42, 0, 0}, {0x518e, 0x38, 0, 0}, {0x518f, 0x56, 0, 0},
	{0x5190, 0x42, 0, 0}, {0x5191, 0xf8, 0, 0}, {0x5192, 0x04, 0, 0},
	...
	{0x5384, 0x0b, 0, 0}, {0x5385, 0x84, 0, 0}, {0x5386, 0x8f, 0, 0},
	{0x5387, 0x82, 0, 0}, {0x5388, 0x71, 0, 0}, {0x5389, 0x11, 0, 0},
	{0x538a, 0x01, 0, 0}, {0x538b, 0x98, 0, 0}, {0x5300, 0x08, 0, 0},
	{0x5301, 0x30, 0, 0}, {0x5302, 0x18, 0, 0}, {0x5303, 0x08, 0, 0},
	{0x5304, 0x08, 0, 0}, {0x5305, 0x30, 0, 0}, {0x5306, 0x08, 0, 0},
	{0x5307, 0x16, 0, 0}, {0x5309, 0x08, 0, 0}, {0x530a, 0x30, 0, 0},
	{0x530b, 0x04, 0, 0}, {0x530c, 0x06, 0, 0}, {0x5480, 0x01, 0, 0},
	{0x5481, 0x0e, 0, 0}, {0x5482, 0x18, 0, 0}, {0x5483, 0x2b, 0, 0},
	{0x5484, 0x52, 0, 0}, {0x5485, 0x65, 0, 0}, {0x5486, 0x71, 0, 0},
	{0x5487, 0x7d, 0, 0}, {0x5488, 0x87, 0, 0}, {0x5489, 0x91, 0, 0},
	{0x548a, 0x9a, 0, 0}, {0x548b, 0xaa, 0, 0}, {0x548c, 0xb8, 0, 0},
	{0x548d, 0xcd, 0, 0}, {0x548e, 0xdd, 0, 0}, {0x548f, 0xea, 0, 0},
	{0x5490, 0x1d, 0, 0}, {0x5580, 0x06, 0, 0}, {0x5583, 0x40, 0, 0},
	{0x5584, 0x28, 0, 0}, {0x5589, 0x18, 0, 0}, {0x558a, 0x00, 0, 0},
	{0x558b, 0x3c, 0, 0}, {0x5800, 0x3f, 0, 0}, {0x5801, 0x16, 0, 0},
	...
	{0x3a1b, 0x38, 0, 0}, {0x3a1e, 0x30, 0, 0}, {0x3a11, 0x70, 0, 0},
	{0x3a1f, 0x18, 0, 0},  
};

static struct reg_value ov5645_setting_30fps_SXGA_1280_960[] = {
	{0x3618, 0x00, 0, 0}, {0x3035, 0x21, 0, 0}, {0x3036, 0x70, 0, 0},
	{0x3600, 0x09, 0, 0}, {0x3601, 0x43, 0, 0}, {0x3708, 0x66, 0, 0},
	{0x370c, 0xc3, 0, 0}, {0x3803, 0x06, 0, 0}, {0x3806, 0x07, 0, 0},
	{0x3807, 0x9d, 0, 0}, {0x3808, 0x05, 0, 0}, {0x3809, 0x00, 0, 0},
	{0x380a, 0x03, 0, 0}, {0x380b, 0xc0, 0, 0}, {0x380c, 0x07, 0, 0},
	{0x380d, 0x68, 0, 0}, {0x380e, 0x03, 0, 0}, {0x380f, 0xd8, 0, 0},
	{0x3814, 0x31, 0, 0}, {0x3815, 0x31, 0, 0}, {0x3820, 0x41, 0, 0},
	{0x3821, 0x07, 0, 0}, {0x3a02, 0x03, 0, 0}, {0x3a03, 0xd8, 0, 0},
	{0x3a08, 0x01, 0, 0}, {0x3a09, 0xf8, 0, 0}, {0x3a0a, 0x01, 0, 0},
	{0x3a0b, 0xa4, 0, 0}, {0x3a0e, 0x02, 0, 0}, {0x3a0d, 0x02, 0, 0},
	{0x3a14, 0x03, 0, 0}, {0x3a15, 0xd8, 0, 0}, {0x3a18, 0x00, 0, 0},
	{0x3a19, 0xf8, 0, 0}, {0x4004, 0x02, 0, 0}, {0x4005, 0x18, 0, 0},
	{0x4837, 0x10, 0, 0}, {0x3503, 0x00, 0, 0}, {0x4300, 0x32, 0, 0},
	{0x4202, 0x00, 0, 0},
};

static struct reg_value ov5645_setting_15fps_SXGA_1280_960[] = {
	{0x3618, 0x00, 0, 0}, {0x3035, 0x41, 0, 0}, {0x3036, 0x70, 0, 0},
	{0x3600, 0x09, 0, 0}, {0x3601, 0x43, 0, 0}, {0x3708, 0x66, 0, 0},
	{0x370c, 0xc3, 0, 0}, {0x3803, 0x06, 0, 0}, {0x3806, 0x07, 0, 0},
	{0x3807, 0x9d, 0, 0}, {0x3808, 0x05, 0, 0}, {0x3809, 0x00, 0, 0},
	{0x380a, 0x03, 0, 0}, {0x380b, 0xc0, 0, 0}, {0x380c, 0x07, 0, 0},
	{0x380d, 0x68, 0, 0}, {0x380e, 0x03, 0, 0}, {0x380f, 0xd8, 0, 0},
	{0x3814, 0x31, 0, 0}, {0x3815, 0x31, 0, 0}, {0x3820, 0x41, 0, 0},
	{0x3821, 0x07, 0, 0}, {0x3a02, 0x04, 0, 0}, {0x3a03, 0x60, 0, 0},
	{0x3a08, 0x01, 0, 0}, {0x3a09, 0xf8, 0, 0}, {0x3a0a, 0x01, 0, 0},
	{0x3a0b, 0xa4, 0, 0}, {0x3a0e, 0x02, 0, 0}, {0x3a0d, 0x02, 0, 0},
	{0x3a14, 0x03, 0, 0}, {0x3a15, 0xd8, 0, 0}, {0x3a18, 0x00, 0, 0},
	{0x3a19, 0xf8, 0, 0}, {0x4004, 0x02, 0, 0}, {0x4005, 0x18, 0, 0},
...
static struct reg_value ov5645_setting_30fps_VGA_640_480[] = {		/* VGA:30fps configuration test OK */
 	{0x3618, 0x00, 0, 0},
	{0x3035, 0x11, 0, 0}, {0x3036, 0x46, 0, 0}, {0x3600, 0x09, 0, 0},
	{0x3601, 0x43, 0, 0}, {0x3708, 0x64, 0, 0}, {0x370c, 0xc3, 0, 0},
	{0x3814, 0x31, 0, 0},
	...
	{0x380e, 0x04, 0, 0}, {0x380f, 0x38, 0, 0}, {0x3810, 0x00, 0, 0},
	{0x3811, 0x10, 0, 0}, {0x3812, 0x00, 0, 0}, {0x3813, 0x06, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3a02, 0x03, 0, 0},
	{0x3a03, 0xd8, 0, 0}, {0x3a08, 0x01, 0, 0}, {0x3a09, 0x0e, 0, 0},
	{0x3a0a, 0x00, 0, 0}, {0x3a0b, 0xf6, 0, 0}, {0x3a0e, 0x03, 0, 0},
	{0x3a0d, 0x04, 0, 0}, {0x3a14, 0x03, 0, 0}, {0x3a15, 0xd8, 0, 0},
	{0x4004, 0x02, 0, 0}, {0x4005, 0x18, 0, 0}, {0x4837, 0x16, 0, 0},
	{0x3503, 0x00, 0, 0},
};

static struct reg_value ov5645_setting_15fps_VGA_640_480[] = {		/* VGA:30fps configuration  */
	{0x3618, 0x00, 0, 0},
	{0x3035, 0x11, 0, 0}, {0x3036, 0x54, 0, 0}, {0x3600, 0x08, 0, 0},
	{0x3601, 0x33, 0, 0}, {0x3708, 0x63, 0, 0}, {0x370c, 0xc3, 0, 0},
	{0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	{0x3802, 0x00, 0, 0}, {0x3803, 0x00, 0, 0}, {0x3804, 0x0a, 0, 0},
	{0x3805, 0x3f, 0, 0}, {0x3806, 0x07, 0, 0}, {0x3807, 0x9f, 0, 0},
	{0x3808, 0x02, 0, 0}, {0x3809, 0x80, 0, 0}, {0x380a, 0x01, 0, 0},
	{0x380b, 0xe0, 0, 0}, {0x380c, 0x0b, 0, 0}, {0x380d, 0x1c, 0, 0},
	{0x380e, 0x07, 0, 0}, {0x380f, 0xb0, 0, 0}, {0x3810, 0x00, 0, 0},
	{0x3811, 0x10, 0, 0}, {0x3812, 0x00, 0, 0}, {0x3813, 0x06, 0, 0},
	{0x3820, 0x40, 0, 0}, {0x3821, 0x06, 0, 0}, {0x3a02, 0x07, 0, 0},
	...
	{0x4004, 0x06, 0, 0}, {0x4005, 0x18, 0, 0}, {0x4837, 0x0b, 0, 0},
	{0x3503, 0x00, 0, 0}, 
};

static struct reg_value ov5645_setting_30fps_XGA_1024_768[] = {		/* 1024x768 :30fps configuration test OK */
	{0x3618, 0x00, 0, 0},
	{0x3035, 0x11, 0, 0}, {0x3036, 0x70, 0, 0}, {0x3600, 0x09, 0, 0},
	{0x3601, 0x43, 0, 0}, {0x3708, 0x64, 0, 0}, {0x370c, 0xc3, 0, 0},
	{0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	{0x3802, 0x00, 0, 0}, {0x3803, 0x06, 0, 0}, {0x3804, 0x0a, 0, 0},
	{0x3805, 0x3f, 0, 0}, {0x3806, 0x07, 0, 0}, {0x3807, 0x9d, 0, 0},
	{0x3808, 0x04, 0, 0}, {0x3809, 0x00, 0, 0}, {0x380a, 0x03, 0, 0},
	{0x380b, 0x00, 0, 0}, {0x380c, 0x07, 0, 0}, {0x380d, 0x68, 0, 0},
...
static struct reg_value ov5645_setting_15fps_XGA_1024_768[] = {		/* 1024x768 :15fps configuration from OV */
	{0x3035, 0x11, 0, 0}, {0x3036, 0x54, 0, 0}, {0x3c07, 0x07, 0, 0},
	{0x3c09, 0xc2, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x40, 0, 0}, {0x3821, 0x06, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	{0x3802, 0x00, 0, 0}, {0x3803, 0x00, 0, 0}, {0x3804, 0x0a, 0, 0},
	{0x3805, 0x3f, 0, 0}, {0x3806, 0x07, 0, 0}, {0x3807, 0x9f, 0, 0},
	{0x3808, 0x04, 0, 0}, {0x3809, 0x00, 0, 0}, {0x380a, 0x03, 0, 0},
	...
	{0x380e, 0x07, 0, 0}, {0x380f, 0xb0, 0, 0}, {0x3810, 0x00, 0, 0},
	{0x3811, 0x10, 0, 0}, {0x3812, 0x00, 0, 0}, {0x3813, 0x06, 0, 0},
	{0x3618, 0x00, 0, 0}, {0x3612, 0xab, 0, 0}, {0x3708, 0x63, 0, 0},
	{0x3709, 0x12, 0, 0}, {0x370c, 0xc0, 0, 0}, {0x3a02, 0x07, 0, 0},
	{0x3a03, 0xb0, 0, 0}, {0x3a08, 0x01, 0, 0}, {0x3a09, 0x27, 0, 0},
	{0x3a0a, 0x00, 0, 0}, {0x3a0b, 0xf6, 0, 0}, {0x3a0e, 0x06, 0, 0},
	{0x3a0d, 0x08, 0, 0}, {0x3a14, 0x07, 0, 0}, {0x3a15, 0xb0, 0, 0},
	{0x4001, 0x02, 0, 0}, {0x4004, 0x06, 0, 0}, {0x460b, 0x37, 0, 0}, 
	{0x460c, 0x20, 0, 0}, {0x3824, 0x01, 0, 0}, {0x5001, 0x83, 0, 0}, 
	{0x3808, 0x04, 0, 0}, {0x3809, 0x00, 0, 0}, {0x380a, 0x03, 0, 0}, 
	{0x380b, 0x00, 0, 0},
};
...
static struct reg_value ov5645_setting_30fps_NTSC_720_480[] = {
	{0x3618, 0x00, 0, 0},
	{0x3035, 0x11, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3600, 0x09, 0, 0},
	{0x3601, 0x43, 0, 0}, {0x3708, 0x64, 0, 0}, {0x370c, 0xc3, 0, 0},
	{0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	{0x3802, 0x00, 0, 0}, {0x3803, 0x04, 0, 0}, {0x3804, 0x0a, 0, 0},
...
static struct reg_value ov5645_setting_15fps_NTSC_720_480[] = {
	{0x3618, 0x00, 0, 0},
	{0x3035, 0x21, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3600, 0x09, 0, 0},
	{0x3601, 0x43, 0, 0}, {0x3708, 0x64, 0, 0}, {0x370c, 0xc3, 0, 0},
	{0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	{0x3802, 0x00, 0, 0}, {0x3803, 0x04, 0, 0}, {0x3804, 0x0a, 0, 0},
...
static struct reg_value ov5645_setting_30fps_720P_1280_720[] = {		/* 720P:30fps configuration test OK */
	{0x3618, 0x00, 0, 0}, {0x3035, 0x11, 0, 0}, {0x3036, 0x54, 0, 0}, 
	{0x3600, 0x09, 0, 0}, {0x3601, 0x43, 0, 0}, {0x3708, 0x64, 0, 0}, 
	{0x370c, 0xc3, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	...
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3a02, 0x02, 0, 0},
	{0x3a03, 0xe4, 0, 0}, {0x3a08, 0x01, 0, 0}, {0x3a09, 0xbc, 0, 0},
	{0x3a0a, 0x01, 0, 0}, {0x3a0b, 0x72, 0, 0}, {0x3a0e, 0x01, 0, 0},
	{0x3a0d, 0x02, 0, 0}, {0x3a14, 0x02, 0, 0}, {0x3a15, 0xe4, 0, 0},
	{0x4004, 0x02, 0, 0}, {0x4005, 0x18, 0, 0}, {0x4837, 0x16, 0, 0},
	{0x3503, 0x00, 0, 0}, {0x3008, 0x02, 0, 0},
};

static struct reg_value ov5645_setting_15fps_720P_1280_720[] = {   /* 720P:15fps configuration  */
	{0x3618, 0x00, 0, 0},
	{0x3035, 0x22, 0, 0}, {0x3036, 0x70, 0, 0}, {0x3600, 0x09, 0, 0},
	{0x3601, 0x43, 0, 0}, {0x3708, 0x66, 0, 0}, {0x370c, 0xc3, 0, 0},
	{0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
	{0x3802, 0x00, 0, 0}, {0x3803, 0x04, 0, 0}, {0x3804, 0x0a, 0, 0},
	{0x3805, 0x3f, 0, 0}, {0x3806, 0x07, 0, 0}, {0x3807, 0x9b, 0, 0},
	{0x3808, 0x02, 0, 0}, {0x3809, 0x80, 0, 0}, {0x380a, 0x01, 0, 0},
	{0x380b, 0xe0, 0, 0}, {0x380c, 0x1c, 0, 0}, {0x380d, 0x68, 0, 0},
	{0x380e, 0x03, 0, 0}, {0x380f, 0xd8, 0, 0}, {0x3810, 0x00, 0, 0},
	{0x3811, 0x10, 0, 0}, {0x3812, 0x00, 0, 0}, {0x3813, 0x06, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3a02, 0x02, 0, 0},
	{0x3a03, 0xd8, 0, 0}, {0x3a08, 0x01, 0, 0}, {0x3a09, 0xf8, 0, 0},
	{0x3a0a, 0x01, 0, 0}, {0x3a0b, 0xa4, 0, 0}, {0x3a0e, 0x02, 0, 0},
	{0x3a0d, 0x02, 0, 0}, {0x3a14, 0x03, 0, 0}, {0x3a15, 0xd8, 0, 0},
	{0x4004, 0x02, 0, 0}, {0x4005, 0x18, 0, 0}, {0x4837, 0x42, 0, 0},
	{0x3503, 0x00, 0, 0}, {0x3008, 0x02, 0, 0},
};

static struct reg_value ov5645_setting_30fps_1080P_1920_1080[] = {
	{0x3612, 0xab, 0, 0},	
	{0x3614, 0x50, 0, 0}, {0x3618, 0x04, 0, 0},
	{0x3035, 0x21, 0, 0}, {0x3036, 0x70, 0, 0},
	{0x3600, 0x08, 0, 0}, {0x3601, 0x33, 0, 0}, {0x3708, 0x63, 0, 0},
	{0x370c, 0xc0, 0, 0}, {0x3800, 0x01, 0, 0}, {0x3801, 0x50, 0, 0}, 
	...
	{0x3811, 0x10, 0, 0}, {0x3812, 0x00, 0, 0}, {0x3813, 0x04, 0, 0},
	{0x3814, 0x11, 0, 0}, {0x3815, 0x11, 0, 0}, {0x3820, 0x41, 0, 0}, 
	{0x3821, 0x07, 0, 0}, {0x3a02, 0x04, 0, 0}, {0x3a03, 0x90, 0, 0},
	{0x3a08, 0x01, 0, 0}, {0x3a09, 0xf8, 0, 0}, {0x3a0a, 0x01, 0, 0},
	{0x3a0b, 0xf8, 0, 0}, {0x3a0e, 0x02, 0, 0}, {0x3a0d, 0x02, 0, 0},
	{0x3a14, 0x04, 0, 0}, {0x3a15, 0x90, 0, 0}, {0x3a18, 0x00, 0, 0},
	{0x4004, 0x02, 0, 0}, {0x4005, 0x18, 0, 0}, {0x4837, 0x10, 0, 0}, 
	{0x3503, 0x00, 0, 0}, 
};

static struct reg_value ov5645_setting_15fps_1080P_1920_1080[] = {	/* 1080P :15fps configuration  */
	{0x3612, 0xab, 0, 0},	
	{0x3614, 0x50, 0, 0}, {0x3618, 0x04, 0, 0},
	{0x3035, 0x11, 0, 0}, {0x3036, 0x54, 0, 0},
	{0x3600, 0x08, 0, 0}, {0x3601, 0x33, 0, 0}, {0x3708, 0x63, 0, 0},
	{0x370c, 0xc0, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0}, 
	{0x3802, 0x00, 0, 0}, {0x3803, 0x00, 0, 0}, {0x3804, 0x0a, 0, 0}, 
	{0x3805, 0x3f, 0, 0}, {0x3806, 0x07, 0, 0}, {0x3807, 0x9f, 0, 0}, 
	{0x3808, 0x07, 0, 0}, {0x3809, 0x80, 0, 0}, {0x380a, 0x04, 0, 0}, 
	{0x380b, 0x38, 0, 0}, {0x380c, 0x0b, 0, 0}, {0x380d, 0x1c, 0, 0}, 
	{0x380e, 0x07, 0, 0}, {0x380f, 0xb0, 0, 0}, {0x3810, 0x00, 0, 0},
	{0x3811, 0x10, 0, 0}, {0x3812, 0x00, 0, 0}, {0x3813, 0x06, 0, 0},
	{0x3814, 0x11, 0, 0}, {0x3815, 0x11, 0, 0}, {0x3820, 0x40, 0, 0}, 
	{0x3821, 0x06, 0, 0}, {0x3a02, 0x07, 0, 0}, {0x3a03, 0xb0, 0, 0},
	{0x3a08, 0x01, 0, 0}, {0x3a09, 0x27, 0, 0}, {0x3a0a, 0x00, 0, 0},
	{0x3a0b, 0xf6, 0, 0}, {0x3a0e, 0x06, 0, 0}, {0x3a0d, 0x08, 0, 0},
	{0x3a14, 0x07, 0, 0}, {0x3a15, 0xb0, 0, 0}, {0x3a18, 0x00, 0, 0},
	{0x4004, 0x06, 0, 0}, {0x4005, 0x18, 0, 0}, {0x4837, 0x0b, 0, 0}, 
	{0x3503, 0x00, 0, 0}, 
};

static struct reg_value ov5645_setting_15fps_QSXGA_2592_1944[] = {		/* 2592x1944 :15fps configuration  */
	...
	{0x380e, 0x07, 0, 0}, {0x380f, 0xb0, 0, 0}, {0x3810, 0x00, 0, 0},
	{0x3811, 0x10, 0, 0}, {0x3812, 0x00, 0, 0}, {0x3813, 0x04, 0, 0},
	{0x3618, 0x04, 0, 0}, {0x3612, 0xab, 0, 0}, {0x3708, 0x21, 0, 0},
...
static struct ov5645_mode_info ov5645_mode_info_data[2][ov5645_mode_MAX+1] = {
	{
		...
		{ov5645_mode_QVGA_320_240, -1, 0,  0,NULL,0},
		...
		{ov5645_mode_XGA_1280_960, SUBSAMPLING, 1280, 960,
		ov5645_setting_15fps_SXGA_1280_960,
		ARRAY_SIZE(ov5645_setting_15fps_SXGA_1280_960)},
	},
	{
		{ov5645_mode_VGA_640_480, SUBSAMPLING, 640,  480,
		...
		{ov5645_mode_XGA_1280_960, SUBSAMPLING, 1280, 960,
		ov5645_setting_30fps_SXGA_1280_960,
		ARRAY_SIZE(ov5645_setting_30fps_SXGA_1280_960)},
	},
};
