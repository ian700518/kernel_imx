...
extern int picc_power_on(struct picc_device *picc, u8 *atrBuf, u32 *atrLen);
extern void picc_power_off(struct picc_device *picc);
extern int picc_command_exchange(struct picc_device *picc, u8 *cmdBuf, u32 cmdLen, u8 *resBuf, u32 *resLen, u8 *level);
extern int picc_init(struct pcd_common *common);
extern void picc_uninit(void);
extern int picc_param_init(struct pcd_common *common, u32 fsd);
extern void picc_polling_tags(struct picc_device *picc);
