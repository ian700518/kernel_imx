...
void picc_polling_tags(struct picc_device *picc)
{
...
int picc_power_on(struct picc_device *picc, u8 *atrBuf, u32 *atrLen)
{
    int ret = 0;
...
int picc_command_exchange(struct picc_device *picc, u8 *cmdBuf, u32 cmdLen, u8 *resBuf, u32 *resLen, u8 *level)
{
    int ret = 0;
    u32 tempLe;
    u8 i;
...
int picc_param_init(struct pcd_common *common, u32 fsd)
{
...
int picc_init(struct pcd_common *common)
{
	int ret = 0;       
